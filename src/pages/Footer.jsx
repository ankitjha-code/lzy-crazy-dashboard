...
import { Facebook, Twitter, Instagram, Linkedin, Youtube, Github, Globe, ChevronDown, X } from "lucide-react";
...
const Footer = () => {
  ...
  return (
    <form onSubmit={handleSubmit} className="w-full card-container max-w-[1550px] mx-auto min-h-screen bg-white rounded-xl border border-gray-200 shadow-md mb-8 px-1 py-6 md:p-6">
